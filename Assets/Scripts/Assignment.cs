...
public class Assignment : MonoBehaviour
{
    ...
    public void As05_IsLeapYear()
    {
        ...
        // Example: Debug.Log("True");
        if (as05Year % 400 == 0) Debug.Log("True");
        else if (as05Year % 100 == 0) Debug.Log("False");
        else if (as05Year % 4 == 0) Debug.Log("True");
        else Debug.Log("False");
    }
    ...
    public void As06_Calculate()
    {
        ...
        {
            case '+': 
                double result = as06Num1 + as06Num2;
    ...
    public void As07_GetSeason()
    {
        ...
        {
            if (as07Month == 12 || as07Month == 1 || as07Month == 2) Debug.Log("It's Winter.");
            else if (as07Month >= 3 && as07Month <= 5) Debug.Log("It's Spring.");
            else if (as07Month >= 6 && as07Month <= 8) Debug.Log("It's Summer.");
            else if (as07Month >= 9 && as07Month <= 11) Debug.Log("It's Fall.");
        }
    ...
    {
        if (as08Quantity <= 0) Debug.Log("Out of stock");
        else
        {
            if (as08Payment >= as08Price)
            {
                Debug.Log("You got a product");
                if (as08Payment > as08Price)
                {
                    Debug.Log("You got " + (as08Payment - as08Price) + " baht");
                }
            }
            else Debug.Log("You don't have enogh money");
        }
    }
    ...
    public void As09_RockPaperScissorsExample()
    {
        ...
        if (as09UserChoice > 2) Debug.Log("Please choose the right number");
        else if (as09UserChoice == as09ComputerChoice) Debug.Log("Tie");
        else if (as09UserChoice == 0 && as09ComputerChoice == 2 || as09UserChoice == 1 && as09ComputerChoice == 0 || as09UserChoice == 2 && as09ComputerChoice == 1) Debug.Log("You win!");
    ...
    public void As10_CalculateWeaponDamage()
    {
        ...
        switch (as10WeaponType?.ToLower())
        {
            ...
            case "unknown": multiplier = 1.0; break;    
